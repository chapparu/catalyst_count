...
SECRET_KEY = 'django-insecure-tahx1o!cp8pnsw_8b9=o-)qft)a$x1z=v^mo+3z_hzlge(s3mw'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv("DB_Name") or "catalyst_count",
        'USER': os.getenv("DB_User") or "postgres",
        'PASSWORD': os.getenv("DB_Password") or "ROOT#123",
